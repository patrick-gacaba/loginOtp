            ...
            <div class="login-box card">
                ...
                <div id="loginform" class="show">
                        ...
                        <div class="form-group text-center m-t-20">
                            <div class="col-xs-12">
                                <button class="btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light" id="loginButton" >Log In</button>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div id="otpdiv" class="hide">
                        ...
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control" type="text" required="" placeholder="Enter OTP" name="OTP" id="otp"> </div>
                        </div>
                        <div class="form-group text-center m-t-20">
                            <div class="col-xs-12">
                                <button class="btn btn-primary btn-lg btn-block text-uppercase waves-effect waves-light" id="otpButton">Submit</button>
                            </div>
                        </div>
                    </div>
